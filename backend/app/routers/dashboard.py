...
async def get_dashboard_stats(
    ...
    return {
        ...
        "task_count": 0,  # TODO: Implement when task model is ready
        "schedule_count": 0,  # TODO: Implement when schedule model is ready
        "llm_config_count": llm_count,
        "tool_count": tool_count,
        "recent_runs": []  # TODO: Implement when run_log model is ready
    }
